...
## 2. The central unknown

> **SPIKE-A01 — Does Bigtop 3.3.0 publish aarch64 RPMs for the components this project needs,
> for the base OS this project uses?**

Everything in this feature branches on the answer. Feature 001's **T003** produces it.

Do not begin implementation work here until T003 has reported. Guessing wrong in either
direction is expensive: assuming packages exist wastes a sprint discovering they do not;
assuming they do not wastes weeks building what could have been downloaded.
...
|---|---|---|
| Path C confirmed — no aarch64 packages at all | Weeks of work; feature 001's release gate blocked | Confirm scope with the project owner before starting. Consider the time-boxed exception in P5 while the build pipeline is developed. |
